<?php
	...
	$aboutTxt = '<h1>Comment ça marche ?</h1>
		<p class="paragraphe">Vous <a href="contact.php">nous contactez</a> pour un audit gratuit de la sécurité de votre site Web. Nous effectuerons une series de test afin de tenter de "pirater" votre site. Apres cela nous vous envoyons un rapport detaillé sur les differentes fails que nous avons trouvé (Si nous en trouvons !) ainsi que des conseils pour la sécurisation de votre application.</p>
		<h1>Pour qui ?</h1>
		<p class="paragraphe">Tous le monde ! Du simple portfolio au complexe site d\'icommerce. </p>
		<h1>Est-ce dangereux ?</h1>
		<p class="paragraphe">Pas du tout ! Parce que nous ne somme pas de r&eacute;el hacker nous n\'exploitons pas les failles que nous decouvrons. Cependant nous utilisons divers outils qui peuvent creer des entr&eacute;es &eacute;trange dans votre base de donn&eacute;e, nous vous recommandons de cr&eacute;er un backup de votre base de donn&eacute;e avant de nous soumettre votre site. 
		...
		<p class="paragraphe">Nous faisons cela principalement pour le fun et pour apprendre. Nous sommes loin d\'etre des profesionnel et nous n\'estimons pas fournir un service sans failles. Nous vous aidons a s&eacute;curiser votre site, en contre partie vous nous aidez a nous am&eacute;liorer. </p>
